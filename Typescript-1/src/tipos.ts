...
//string
const nome: string = 'Fernando Henrique';
...
function idadeAltura(idade: number, altura: number): number{
    return idade + altura;
}
...
const testeValores = (aprovado: boolean, reprovado: boolean): boolean =>{
...
//array
const frutas: string[] = ['melância', 'maçã', 'morango'];
...
//tuplas
const endereço1: [string, number, string] = ['W5 norte', 915, 'Asa Norte'];
...
const modificaEndereço = (endereço: [string, number, string]): [string, number,string] => {
